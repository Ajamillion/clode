...
class SchemaExportTests(unittest.TestCase):
    ...
    def test_hybrid_response_schema_exposes_plane_metrics(self) -> None:
        ...
        self.assertIn("port_vortex_loss_db", schema["properties"])
        self.assertIn("port_noise_spl_db", schema["properties"])
        summary_props = summary["properties"]
        self.assertIn("max_port_vortex_loss_db", summary_props)
        self.assertIn("max_port_noise_spl_db", summary_props)
        self.assertIn("port_noise_reference_distance_m", summary_props)
