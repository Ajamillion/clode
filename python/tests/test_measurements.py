...
class MeasurementComparisonTests(unittest.TestCase):
    ...
    def test_compare_identical_trace(self) -> None:
        ...
        self.assertIsNotNone(stats.spl_interquartile_range_db)
        assert stats.spl_interquartile_range_db is not None
        self.assertLess(stats.spl_interquartile_range_db, 1e-6)
    ...
    def test_compare_with_smoothing_reduces_max_delta(self) -> None:
        ...
        assert unsmoothed_stats.spl_interquartile_range_db is not None
        assert smoothed_stats.spl_interquartile_range_db is not None
        self.assertLessEqual(
            smoothed_stats.spl_interquartile_range_db,
            unsmoothed_stats.spl_interquartile_range_db,
        )
