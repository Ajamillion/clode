...
def hybrid_simulation_response_schema() -> dict[str, Any]:
    ...
    properties: dict[str, Any] = {
        ...
        "port_vortex_loss_db": _number_array_schema(
            title="Port vortex shedding loss (dB)",
            min_items=1,
            description="Estimated loss from port vortex shedding (zeros for sealed systems).",
        ),
        "port_noise_spl_db": _number_array_schema(
            title="Port jet noise SPL (dB)",
            min_items=1,
