...
class MeasurementStats:
    ...
    spl_interquartile_range_db: float | None
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "spl_interquartile_range_db": self.spl_interquartile_range_db,
...
def compare_measurement_to_prediction(
    ...
    *,
    ...
    stats = MeasurementStats(
        ...
        spl_interquartile_range_db=_interquartile_range_abs(spl_delta),
...
def _interquartile_range_abs(values: Sequence[float] | None) -> float | None:
    if values is None:
        return None
    upper = _percentile_abs(values, 0.75)
    lower = _percentile_abs(values, 0.25)
