...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if args.json:
        ...
        print(
            "SPL median abs dev: "
            f"{_format_float(stats.spl_median_abs_dev_db)} dB"
        )
        print(f"SPL IQR: {_format_float(stats.spl_interquartile_range_db)} dB")
        ...
        if calibrated_stats and calibrated_delta and calibrated_diagnosis:
            ...
            print(
                "SPL median abs dev after calibration: "
                f"{_format_float(calibrated_stats.spl_median_abs_dev_db)} dB"
                f" (was {_format_float(stats.spl_median_abs_dev_db)} dB)"
            )
            print(
                "SPL IQR after calibration: "
                f"{_format_float(calibrated_stats.spl_interquartile_range_db)} dB"
                f" (was {_format_float(stats.spl_interquartile_range_db)} dB)"
            )
            print(
