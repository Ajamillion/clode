...
- FastAPI app that:
  ...
  - Streams hybrid solver responses via `/simulate/hybrid`, returning multi-plane pressure slices with per-plane maxima/means and hotspot coordinates for Studio overlays.
