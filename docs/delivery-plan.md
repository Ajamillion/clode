...
- Latest iteration adds the hybrid aeroacoustic heuristics so Studio and the gateway can flag chuffing risk with estimated vortex losses and jet-noise levels alongside the existing measurement QA overlays.
