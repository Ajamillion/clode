...
export function MeasurementPanel() {
  ...
  const highlightEntries = useMemo(() => {
    ...
    if (stats) {
      ...
      if (stats.spl_interquartile_range_db != null)
        entries.push({ label: 'SPL IQR', value: formatDecibel(stats.spl_interquartile_range_db) })
    ...
    if (calibrated) {
      ...
      if (calStats) {
        ...
        if (calStats.spl_interquartile_range_db != null) {
          entries.push({ label: 'Rerun SPL IQR', value: formatDecibel(calStats.spl_interquartile_range_db) })
        }
